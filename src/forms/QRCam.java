...
public class QRCam extends javax.swing.JFrame implements Runnable, ThreadFactory {
...
//    private static final long serialVersionUID = 6441489157408381878L;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QRCam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
...
//        Webcam.getWebcams().get(0).close();
    ...
    public void run() {
        ...
        while(true){
            ...
            if(!this.isShowing()){
                webcam.close();
                System.out.println("chuan bi tat");
                break;
            }
            if (webcam.isOpen()) {
            ...
            if (result != null) {
                ...
                for(int i=0;i<list.size();i++){
                    if(ketqua.equals(list.get(i).getManv()+list.get(i).getMatkhau())){
                        Tienich.user=list.get(i);
                        Tienich.check=true;
                        this.dispose();
                        webcam.close();
                        check=true;
